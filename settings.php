...
if ($hassiteconfig) {
    ...
    $replychoices = [REMINDERS_SEND_AS_ADMIN => get_string('sendasadmin', 'local_reminders'),
    ...
    $choices = [REMINDERS_SEND_ALL_EVENTS => get_string('filtereventssendall', 'local_reminders'),
    ...
    $settings->add(
        new admin_setting_configmulticheckbox2(
    ...
    $activitychoices = [REMINDERS_ACTIVITY_BOTH => get_string('activityremindersboth', 'local_reminders'),
