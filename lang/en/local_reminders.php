...
$string['activityignoreincompletesdetails'] = 'If checked, then no reminders will be sent if the activity is already completed by user <strong>before</strong> the activity is end.';
