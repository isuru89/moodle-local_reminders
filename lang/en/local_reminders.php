...
$string['footercustomname'] = 'Customized Email Footer';
$string['footercustomnamedesc'] = 'Specify the footer content to be embedded in every reminder email message. If this content is empty and default footer is disabled, then footer will remove completely from reminders.';
$string['footerdefaultname'] = 'Use Default Email Footer';
$string['footerdefaultnamedesc'] = 'If checked, then default reminder email footer will contain a link to the Moodle calendar. Otherwise, the content provided in customized footer will be used.';
