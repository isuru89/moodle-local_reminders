...
$string['postactivityreminders'] = 'Post Activity Reminders:';
$string['postactivityremindersdescription'] = 'If checked, then reminders will be sent to users who have not completed the activity yet.';
