...
$string['enabledchangedevents'] = 'Enable for event change:';
$string['enabledchangedeventsdescription'] = 'Indicates whether to send reminders when a calendar event got changed.';
